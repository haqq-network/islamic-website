...
export function DownloadPDFButton({
  ...
  return (
    <Link
      ...
      className="w-[164px] cursor-pointer rounded-[8px] border border-white px-[10px] py-[6px] text-white transition-colors duration-300 hover:border-islamic-primary-green-hover hover:text-islamic-primary-green-hover md:w-[180px]"
      download
    >
      <div className="flex items-center justify-between">
        <div className="flex gap-x-[8px]">
          ...
          <div className="flex flex-col text-[12px] font-[400] leading-[1.5em]">
            <span className="font-vcr uppercase rtl:font-handjet">
