    ...
    <div className="fixed left-0 top-[160px] z-[10] w-full border-b-[1px] border-[#2F2F2F] bg-[#010304CC] backdrop-blur-[6px] min-[370px]:top-[136px] md:top-[112px]">
      <Container>
        <div className="flex flex-col">
          ...
          >
            <div className="py-[14px] font-vcr text-[16px] uppercase leading-[24px] rtl:font-handjet">
              {currentValue ? (
              ...
              {sections.map((section) => {
                return (
                  <LocaleLink
                    ...
                    key={section.id}
                    className={clsx(
                      'inline-flex cursor-pointer items-center justify-between gap-x-[8px] font-vcr uppercase hover:text-islamic-primary-green-hover focus:text-white rtl:font-handjet',
                  ...
                  >
                    <span className="flex w-full flex-row items-center justify-between gap-[6px] py-[8px]">
