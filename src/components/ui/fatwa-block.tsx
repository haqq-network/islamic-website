...
function Autograph({ name, image }: { name: string; image: StaticImageData }) {
  return (
    <div className="flex w-fit flex-col items-start justify-between gap-y-[8px] md:gap-y-[12px]">
      <span className="font-vcr text-[12px] uppercase leading-[18px] md:text-[13px] md:leading-[20px] lg:text-[14px] rtl:font-handjet">
        {name}
      </span>
...
function AutographsBlock() {
  ...
  return (
    <div className="mt-[28px] flex flex-col gap-y-[20px] md:mt-[32px] lg:mt-[36px]">
      <h4 className="font-vcr text-[17px] uppercase leading-[26px] md:text-[18px] lg:text-[20px] lg:leading-[28px] rtl:font-handjet">
