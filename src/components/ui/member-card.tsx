  ...
  return (
    <div
      className={clsx(
        ...
        'rounded-[20px] border border-dashed border-[#585858] hover:border-islamic-primary-green',
          ...
          {url && (
            <div className="mt-[28px]">
              <Link
                ...
                className={clsx(
                  'font-vcr uppercase text-islamic-primary-green hover:text-islamic-primary-green-hover rtl:font-handjet',
