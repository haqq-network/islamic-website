...
export function CEXCard({ name, logo }: CEXCardProps) {
  return (
    ...
    >
      ...
      <div>
        <div className="font-vcr text-[18px] font-[400] uppercase leading-[26px] md:text-[24px] md:leading-[34px] rtl:font-handjet">
          {name}
        </div>

        <div className="mt-[2px] font-alexandria text-[13px] font-[400] leading-[20px] md:mt-[4px] md:text-[18px] md:leading-[24px]">
