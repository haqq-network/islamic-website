...
function BurgerMenuDropdownLink({
  ...
  return (
    <LocaleLink
      href={href}
      className="w-fit py-[12px] text-base font-[500] text-white transition-colors duration-200 hover:text-islamic-primary-green"
      onClick={onClick}
  ...
  return (
    <div className={clsx('px-[16px] md:px-[48px]', className)}>
      ...
      <div className="flex flex-col gap-y-[12px]">
        <LocaleLink
          href="/shariah"
          className="z-50 py-[12px] text-base uppercase text-white transition-colors duration-200 hover:text-islamic-primary-green"
          onClick={onClick}
        >
  ...
  return (
    <Fragment>
      <div
        ...
        className="z-50 flex cursor-default items-center justify-between py-[12px] text-base uppercase text-white transition-colors duration-200 hover:text-islamic-primary-green"
      >
        <div>{title}</div>
