    ...
    >
      ...
      >
        ...
        >
          <div className="flex flex-row flex-wrap gap-[6px]">
            {tags.map((tag) => {
              return (
                <div
                  key={tag}
                  className="max-w-fit rounded-[8px] border border-[#585858] px-[10px] py-[6px] text-center font-vcr text-[12px] uppercase leading-[1.5em] rtl:font-handjet"
                >
                  {tag}
                </div>
              );
          ...
          <div className="font-vcr text-[10px] font-[400] uppercase leading-[16px] text-[#838383] md:text-[11px] md:leading-[18px] lg:text-[12px] rtl:font-handjet">
