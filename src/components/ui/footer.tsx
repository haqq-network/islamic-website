...
function FooterNavLink({
  ...
  return (
    <LocaleLink
      ...
      className="w-fit px-[8px] py-[6px] font-vcr text-[13px] font-[400] uppercase leading-[20px] text-[#F5F5F5] transition-colors duration-150 ease-in hover:text-[#18FFAC] md:text-[14px] lg:text-base rtl:font-handjet"
    >
      {title}
    </LocaleLink>
  );
...
export function Footer({
  ...
  return (
    <footer className="flex w-full flex-col text-white">
      <div className="border-y border-[#2F2F2F] bg-islamic-bg-black/10 py-[32px] backdrop-blur md:py-[56px] lg:py-[80px]">
        <Container>
