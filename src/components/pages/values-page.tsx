...
function ValuesPageHeading({ children }: PropsWithChildren) {
  return (
    <h3 className="font-vcr text-[15px] uppercase leading-[22px] lg:text-[18px] lg:leading-[26px] rtl:font-handjet">
...
export function ValuesPage() {
  ...
  return (
    <section className="overflow-x-clip pb-[60px] pt-[32px] md:pt-[52px] lg:pb-[140px] lg:pt-[68px]">
        ...
        <div className="flex flex-col items-center lg:mt-[60px] lg:flex-row">
          <div className="lg:relative lg:order-2 lg:flex-1">
            <Image
              ...
              height={776}
              alt=""
              className="pointer-events-none select-none lg:absolute lg:left-[50%] lg:top-[50%] lg:z-[-1] lg:translate-x-[-50%] lg:translate-y-[-55%] lg:scale-150 xl:scale-125"
            />
          </div>
