...
export function StatisticsBlockStatCard({
  ...
  return (
    <div className="flex flex-col gap-y-[4px]">
      <div
        className={clsx(
          'pointer-events-none flex h-[34px] select-none flex-row gap-x-[6px] font-vcr text-[24px] leading-[34px] rtl:flex-row-reverse rtl:justify-end rtl:font-handjet',
        )}
      >
        {prefix}
        {startAnimation ? (
...
export function WhyBlock({ stats }: { stats: ChainStats }) {
  ...
  return (
    <section className="transform-gpu divide-y-[1px] divide-[#2F2F2F] rounded-[20px] bg-islamic-primary-graphite px-[20px] py-[28px] text-white backdrop-blur-sm md:p-[40px] lg:mt-[100px] lg:p-[48px]">
      ...
      <div className="flex flex-col items-start pt-[40px]">
        <div className="flex flex-col gap-x-[24px] gap-y-[12px] sm:flex-row">
          ...
          <Link
            ...
            className="flex cursor-pointer items-center gap-x-[8px] font-vcr uppercase text-islamic-primary-green transition-colors duration-300 ease-out hover:text-islamic-primary-green-hover rtl:font-handjet"
          >
