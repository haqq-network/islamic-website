          ...
          <div className="flex min-h-[200px] flex-col items-start lg:flex-row">
                  ...
                  <div>
                    <p>
                      ...
                      <Link
                        ...
                        className="cursor-pointer text-islamic-primary-green transition-colors duration-300 hover:text-islamic-primary-green-hover"
                      >
            ...
            <div className="relative mb-[-30%] w-full flex-1 lg:mb-[0px] lg:min-h-[200px]">
              <div className="pointer-events-none select-none lg:absolute lg:right-[0px] lg:top-[50%] lg:z-[-1] lg:origin-right lg:translate-x-[80%] lg:translate-y-[-50%] lg:scale-150">
                <div className="absolute bottom-[0px] h-[75%] w-full bg-gradient-to-t from-islamic-bg-black from-55% to-transparent lg:right-0 lg:h-full lg:w-[90%] lg:bg-gradient-to-l" />
                <Image
                  alt=""
