      ...
      <Container className="relative">
        ...
        <div className="mt-[32px] flex flex-col items-center md:mt-[44px] md:flex-row md:items-start lg:mt-[60px]">
          <div className="flex flex-col gap-y-[16px] md:max-w-[60%] md:gap-y-[20px] lg:gap-y-[24px]">
            <h2 className="font-vcr text-[18px] uppercase leading-[26px] md:text-[22px] md:leading-[32px] lg:text-[24px] lg:leading-[34px] rtl:font-handjet">
              ...
              <li className="ml-[8px]">
                <Text size="small">
                  {t.rich('how-to-block.identifiers.second', {
                    span: (chunks) => {
                      return (
                        <span className="cursor-pointer text-islamic-primary-green transition-colors duration-300 hover:text-islamic-primary-green-hover">
                          {chunks}
                        </span>
                      );
                    },
