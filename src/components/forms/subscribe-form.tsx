        ...
        >
          ...
          <div className="w-fit text-[12px] text-white">
            ...
            <LocaleLink
              ...
              className="text-islamic-primary-green transition-colors duration-300 hover:text-islamic-primary-green-hover"
            >
              Privacy Policy
            </LocaleLink>
          </div>
      ...
      <Modal onClose={handleSuccessModalClose} isOpen={isSuccessModalOpen}>
        <div className="relative transform-gpu rounded-[20px] bg-[#15191EF2] text-white backdrop-blur">
          ...
          <div className="flex flex-col items-center gap-[16px] px-[40px] py-[32px] lg:gap-[32px] lg:px-[80px] lg:py-[60px]">
            <h3 className="font-vcr text-[18px] uppercase leading-[26px] md:text-[22px] md:leading-[32px] lg:text-[24px] lg:leading-[34px] rtl:font-handjet">
              Congratulations!
            </h3>
